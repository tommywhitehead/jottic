...
var createNodeFromYElement = (el, schema, meta, snapshot2, prevSnapshot, computeYChange) => {
  ...
  const createChildren = (type) => {
    ...
    if (type instanceof YXmlElement) {
      ...
      const nextytext = (
        /** @type {Y.ContentType} */
        (_b = (_a = type._item.right) == null ? void 0 : _a.content) == null ? void 0 : _b.type
      );
...
var equalYTextPText = (ytext, ptexts) => {
  ...
  return delta.length === ptexts.length && delta.every(
    ...
    ptexts[i].text && keys(d.attributes || {}).length === ptexts[i].marks.length && every(d.attributes, (attr, yattrname) => {
      ...
      return equalAttrs2(attr, (_a = pmarks.find(
        /** @param {any} mark */
        (mark) => mark.type.name === markname
      )) == null ? void 0 : _a.attrs);
    })
  );
};
...
var yattr2markname = (attrName) => {
  var _a;
  return ((_a = hashedMarkNameRegex.exec(attrName)) == null ? void 0 : _a[1]) ?? attrName;
};
...
var undo = (state) => {
  var _a, _b;
  return ((_b = (_a = yUndoPluginKey.getState(state)) == null ? void 0 : _a.undoManager) == null ? void 0 : _b.undo()) != null;
};
var redo = (state) => {
  var _a, _b;
  return ((_b = (_a = yUndoPluginKey.getState(state)) == null ? void 0 : _a.undoManager) == null ? void 0 : _b.redo()) != null;
};
...
//# sourceMappingURL=chunk-BI53JRIC.js.map
